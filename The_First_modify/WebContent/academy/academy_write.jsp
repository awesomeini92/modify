...
<!-- 				</tr> -->
				<tr>
					...
					<td class="td_right">주소 <input type="text" name="board_add" id="board_add" required="required"><br>
					학원명 <input type="text" name="academy_name" id="academy_name" required="required">
