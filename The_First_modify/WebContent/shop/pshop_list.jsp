...
<!-- 						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus placerat enim et urna sagittis, rhoncus euismod erat tincidunt. Donec tincidunt volutpat erat.</p> -->
				 ...
				 <div class="">
							...
							<input type="hidden" name="nickname" value="${sessionScope.nickname }">
								  ...
								  <div class="card border-info mb-3" style="max-width: 30rem; text-align: center;">
...
<!-- 								    <h4 class="card-title">Info card title</h4> -->
								    ...
								    <div class="custom-control custom-radio">
								      <input type="radio" id="customRadio100" name="customRadio" class="custom-control-input" >
								      <label class="custom-control-label" for="customRadio100">100 CP</label>
								    </div>
									<div class="custom-control custom-radio">
								      <input type="radio" id="customRadio1" name="priceRadio" class="custom-control-input">
								      <label class="custom-control-label" for="customRadio1">3,000 CP</label>
								    </div>
								    <div class="custom-control custom-radio">
								      <input type="radio" id="customRadio2" name="priceRadio" class="custom-control-input" >
								      <label class="custom-control-label" for="customRadio2">5,000 CP</label>
								    </div>
								    <div class="custom-control custom-radio">
								      <input type="radio" id="customRadio3" name="priceRadio" class="custom-control-input" >
								      <label class="custom-control-label" for="customRadio3">10,000 CP</label>
								    </div>
								     <div class="custom-control custom-radio">
								      <input type="radio" id="customRadio4" name="priceRadio" class="custom-control-input" >
